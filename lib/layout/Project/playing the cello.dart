...
class _PoetryState extends State<Cello> {
          ...
          child: Column(
            ...
            children: [
              Column(
                ...
                children: [
                  Text('''  ساهمت آلة التشيلو الموسيقية بأكثر المقطوعات الموسيقية تأثيراً وانفعالاً عبر" 
 ".التاريخ, ولعب دوراً مهماً في أنواع مختلفة من الموسيقى ''',
           ...
           اظهر موهبتك في العزف علي اله التشيلو ❤️ 🎻''',
              ...
              Column(
                ...
                children: [
                  Text('''
تفاصيل العزف علي التشيلو  في الفئة العمرية من 5 الي 12 سنة''',
                    textDirection: TextDirection.rtl,
...
تفاصيل العزف علي التشيلو  في الفئة العمرية من 12 الي 18 سنة''',
  ...
  المتتاليات الستة كحركة إجبارية + اختيار حركة أولى من أى كونشيرتو أو سوناتا (هايدن، صانصانص، لالو، برامز، ديبوسى).
