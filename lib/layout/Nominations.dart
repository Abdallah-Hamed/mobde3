  ...
  Widget build(BuildContext context) => DefaultTabController(
    ...
    child: Scaffold(
        appBar: AppBar(
          ...
          title: Center(child: Text('الادب',style: TextStyle(fontFamily: 'Amiri',color: Colors.white,fontWeight: FontWeight.bold,fontSize: 26),)),
        ...
        body: Column(
          children: [
            TabBar(
              ...
              tabs: [
                Tab(text: 'الشعر',
                  icon: Icon(Icons.auto_stories_sharp,color:Color(0xff833a5d) ,),),
                Tab(text: 'القصة',
                  icon: Icon(Icons.import_contacts,color:Color(0xff833a5d)),),
                Tab(text: 'المسرحية',
                  icon: Icon(Icons.live_tv,color:Color(0xff833a5d)),),
              ],
            ),
            Expanded(
